  ...
  return (
    <ReaderContent>
      <Masthead
        ...
        dek="Articles you've recommended across the network."
        metaLabel="Recommendations"
        ...
        <div {...stylex.props(styles.emptyCard)}>
          ...
          >
            ...
            <p {...stylex.props(styles.emptyDek)}>
              Tap the heart on any article to recommend it. Your recommendations
              live in your repo as{" "}
