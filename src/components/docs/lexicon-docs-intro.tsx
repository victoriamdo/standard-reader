    ...
    <>
      <div {...stylex.props(docsStyles.masthead)}>
        ...
        <p {...stylex.props(docsStyles.dek)}>
          <Trans>
            Published AT Proto record schemas for reader state in each
            user&apos;s PDS.
          </Trans>
        </p>
      </div>
      ...
      <div {...stylex.props(docsStyles.introProse)}>
        ...
        <p {...stylex.props(docsStyles.prose)}>
          <Trans>
            ...
            state, lists, and related shared definitions. AppView XRPC queries
            and procedures are documented on{" "}
