...
const $nsid = 'app.standard-reader.getAuthorPosts'
...
/** Every article a DID has a byline on — their own posts plus documents they are credited on in other publications (featured in) — newest first, with cursor pagination. */
